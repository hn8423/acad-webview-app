...
export const FEATURE_ROUTE_MAP: Record<string, string> = {
	...
	SUBSCRIPTION_PLAN_MANAGING: '/admin/subscription-plans',
	SUBSCRIPTION_PAYMENT_MANAGING: '/admin/subscriptions',
	SCHEDULE_ALERM_MANAGING: '/admin/scheduled-alarms',
	SUGGESTION_MANAGING: '/admin/suggestions'
};
...
export const FEATURE_ICON_MAP: Record<string, string> = {
	...
	// 지폐 아이콘 — 구독 아이템(상품 정의)
	SUBSCRIPTION_PLAN_MANAGING:
		'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z',
	// 원화 아이콘 — 수납 관리
	SUBSCRIPTION_PAYMENT_MANAGING:
		'M9 8h6M8 12h8M12 12v4m-2-8l2-3 2 3M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
